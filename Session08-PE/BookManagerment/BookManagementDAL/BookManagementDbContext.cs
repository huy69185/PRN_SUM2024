...
public partial class BookManagementDbContext : DbContext
{
    ...
    public BookManagementDbContext(string connectionString)
    {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C2077A3B8434");
        ...
        {
            entity.HasKey(e => e.BookCategoryId).HasName("PK__BookCate__6347EC046FFD70E0");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__UserAcco__0CF04B18DBB0F948");
